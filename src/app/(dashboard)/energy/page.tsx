...
export default async function EnergyPage() {
  const readings: EnergyReading[] = await prisma.energyReading.findMany({
    orderBy: { date: "asc" },
    take: 30,
  });
      ...
      <div className="grid grid-4" style={{ marginBottom: "2rem" }}>
        <div className="card">
          ...
          <div style={{ fontSize: "1.5rem", fontWeight: 700 }}>
            ...
            <span style={{ fontSize: "0.875rem", fontWeight: 400 }}>kWh</span>
          </div>
        </div>
        <div className="card">
      ...
      <div className="card" style={{ marginTop: "1.5rem" }}>
        ...
        <div className="grid grid-3">
          ...
          >
            ...
            <div style={{ color: "#999", fontSize: "0.875rem" }}>
              Switch to LED lights - they use 75% less energy
            </div>
          </div>
          <div
            style={{
          ...
          >
            ...
            <div style={{ color: "#999", fontSize: "0.875rem" }}>
              Set schedules to reduce heating/cooling when away
            </div>
          </div>
          <div
            style={{
          ...
          >
            ...
            <div style={{ color: "#999", fontSize: "0.875rem" }}>
              Standby power can account for 10% of your bill
            </div>
          </div>
        </div>
      </div>
